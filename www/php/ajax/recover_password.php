...
class recover_password extends cs_interaction {
    ...
    protected function get_informations(){
        ...
        $this->email = $connection->get_email($this->username);
    }

    protected function get_returned_data(){
        if ($this->email != null && $this->result == 1) {
            send_email('ds.acconto@gmail.com', 'ds.acconto@gmail.com', 'Asso Antincendio', 'Recupero password',
