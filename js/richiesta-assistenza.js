...
let BtnRichiediAssistenza = $('#BtnRichiediAssistenza');
...
$('#richiestaAssistenzaContrattoSelect').on('change', function(e) {
    ...
    $('#BtnRichiediAssistenza').addClass('ui-disabled');
    ...
    richiestaAssistenzaFilialePromise.then(
        function(data) {
            ...
            if (data.result) {
                ...
                BtnRichiediAssistenza.removeClass('ui-disabled');
            } else {
                $('#assistenzaMessaggioErrore').append('<div class="center-text error-message"><span class="font-large">' + data.message + '</span></div>');
            }
        }
...
$('#BtnRichiediAssistenza').on('click', function() {
    let i = 1;
    let isEmpty = true;
    let isMotiv = true;
                ...
                if (data.result) {
                    ...
                    if (!isMotiv) {
                        ...
                        if (!isEmpty) {
                            ...
                            for (var val of assistenzaFormData.entries()) {
                                console.log(val[0])
                            }
                            //invio richiesta httpxml
