...
function selectFiliale(filiale) {
    ...
    $('#sorveglianzaFilialeSelect').off('change').on('change', function(e) {
        ...
        $('#BtnInviaSorveglianza').removeClass('ui-disabled');
        $('#BtnSospendiSorveglianza').removeClass('ui-disabled');
    });
}
...
$('#BtnSospendiSorveglianza').on('click', function() {
    // $('#sorveglianzaFilialeSelect').removeClass('ui-disabled');
    // $('#sorveglianzaContrattoSelect').removeClass('ui-disabled');
    // $('#BtnSospendiSorveglianza').addClass('ui-disabled');
    // $('#BtnInviaSorveglianza').addClass('ui-disabled');
...
$('#BtnInviaSorveglianza').on('click', function() {
